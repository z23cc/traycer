...
import {
  handleChatReplicaRead,
  handleCloudFeedClear,
  handleCloudFeedClearAll,
  ...
  handleProvidersSetPackPolicy,
  handleProvidersUsePackVersion,
  handleReadCloudChatPart,
  handleReadCloudChatPayload,
  handleSetCloudChatVisibility,
} from "./handlers/cloud-absent-handlers";
import {
...
const CONCRETE_HANDLERS: { readonly [method: string]: RpcHandler } = {
  ...
  "host.notifications.cloudFeed.markRead": handleCloudFeedMarkRead,
  "host.notifications.cloudFeed.resolve": handleCloudFeedResolve,
  "host.notifications.cloudFeed.clear": handleCloudFeedClear,
  "host.notifications.cloudFeed.markAllRead": handleCloudFeedMarkAllRead,
  "host.notifications.cloudFeed.clearAll": handleCloudFeedClearAll,
  "epic.listCloudChatPayloads": handleListCloudChatPayloads,
  "epic.readCloudChatPart": handleReadCloudChatPart,
  ...
  "pr.getLocalDiffSummary": handlePrGetLocalDiffSummary,
  "pr.getLocalFileDiff": handlePrGetLocalFileDiff,
  "providers.installPackVersion": handleProvidersInstallPackVersion,
  "providers.removePackVersion": handleProvidersRemovePackVersion,
